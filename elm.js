...
Elm.Todo.make = function (_elm) {
   ...
   var taskEntry = function (task) {
      ...
      _L.fromArray([A2($Html.h1,
                   ...
                   _L.fromArray([$Html$Attributes.id("new-todo")
                                ...
                                function ($) {
                                   return $Signal.send(updates)(UpdateField($));
                                })
      ...
      return function () {
         ...
         _L.fromArray([A2($Html.div,
                      ...
                      _L.fromArray([A2($Html.input,
                                   ...
                                   _L.fromArray([]))
                                   ,A2($Html.label,
                                   _L.fromArray([$Html$Events.onDoubleClick(A2($Signal.send,
                                   updates,
                                   A2(EditingTask,
                                   todo.id,
                                   true)))]),
                      ...
                      _L.fromArray([$Html$Attributes.$class("edit")
                                   ...
                                   $Html$Events.targetValue,
                                   function ($) {
                                      return $Signal.send(updates)(UpdateTask(todo.id)($));
                                   })
                                   ,$Html$Events.onBlur(A2($Signal.send,
                                   updates,
   ...
   function () {
      ...
      return $Signal.map(toSelector)(A2($Signal.keepIf,
      needsFocus,
      A2(EditingTask,
      0,
      true))($Signal.subscribe(updates)));
   }());
   var emptyState = {_: {}
                    ,field: ""
                    ,tasks: _L.fromArray([])
                    ,uid: 0
                    ,visibility: "All"};
   var startingState = A2($Maybe.withDefault,
   emptyState,
   getStorage);
      ...
      return function () {
         ...
         {case "Add":
            return _U.replace([["uid"
                              ...
                              ,["field",""]
                              ,["tasks"
                               ,$String.isEmpty(state.field) ? state.tasks : A2($Basics._op["++"],
                               state.tasks,
            ...
            return function () {
                 var stepTask = function (t) {
                    return _U.eq(t.id,
                    update._0) ? _U.replace([["completed"
                                             ,update._1]],
                    t) : t;
                 };
            ...
            return function () {
                 var stepTask = function (t) {
                    return _U.eq(t.id,
                    update._0) ? _U.replace([["description"
                                             ,update._1]],
                    t) : t;
                 };
                 return _U.replace([["tasks"
